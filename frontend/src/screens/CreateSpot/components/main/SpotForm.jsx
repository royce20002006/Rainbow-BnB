...
export default function SpotForm() {
  ...
  const [country, setCountry] = useState('dddddd');
  const [address, setAddress] = useState('dddddd');
  const [city, setCity] = useState('ddddd');
  const [state, setState] = useState('ddddd');
  const [lat, setLat] = useState('44');
  const [lng, setLng] = useState('44');
  const [description, setDescription] = useState('dddssssssssssjfdkafkadjhklfdahsfjklhadhflkfhadlksjfhlkdsahflakhfdlakshd')
  const [name, setName] = useState('dddd');
  const [price, setPrice] = useState('4');
  const [previewImage, setPreviewImage] = useState('https://i.redd.it/n6l6pojysy1b1.jpg');
  const [imageOne, setImageOne] = useState('https://i.redd.it/n6l6pojysy1b1.jpg')
